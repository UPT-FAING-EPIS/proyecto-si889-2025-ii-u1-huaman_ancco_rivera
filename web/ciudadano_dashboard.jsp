<%-- 
    Document   : ciudadano_dashboard
    Created on : 2 jun. 2025, 10:37:23
    Author     : ASUS
--%>
...
<head>
    ...
    <title>SIRESA - Portal Ciudadano</title>
...
<body>
    <%
        ...
        if (sesion != null && sesion.getAttribute("usuarioLogueado") != null) {
            userLogueado = (Usuario) sesion.getAttribute("usuarioLogueado");
             if (!"ciudadano".equalsIgnoreCase(userLogueado.getRol())) {
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-secondary"> <%-- Color gris/neutro para ciudadano --%>
        <a class="navbar-brand" href="ciudadano_dashboard.jsp"><i class="fas fa-eye"></i> SIRESA Ciudadano</a>
    ...
    <div class="container mt-4">
        <div class="jumbotron bg-light p-4 mb-4">
            <h1 class="display-5"><i class="fas fa-info-circle"></i> Bienvenido al Portal Ciudadano</h1>
            <p class="lead">Consulte el estado de los establecimientos de comida y bebidas.</p>
        </div>
                    ...
                    <div class="card text-center">
                        <div class="card-body">
                            <div>
                                ...
                                <h5 class="card-title">Consultar Establecimientos</h5>
                            </div>
                            <p class="card-text">Ver la lista de establecimientos y su estado actual de revisión.</p>
                        </div>
                    </div>
                </a>
            </div>
                   ...
                   <div class="card text-center">
                       <div class="card-body">
                           <div>
                               ...
                               <h5 class="card-title">Ver Mapa de Establecimientos</h5>
                           </div>
                           <p class="card-text">Visualizar los establecimientos en un mapa geográfico.</p>
                       </div>
                   </div>
               </a>
           </div>
